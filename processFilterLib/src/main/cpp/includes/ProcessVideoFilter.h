...
#ifndef FFMPEGPRACTICE_PROCESSVIDEOFILTER_H
#define FFMPEGPRACTICE_PROCESSVIDEOFILTER_H
...
public:
    ProcessVideoFilter(JNIEnv *env, jobject thiz);

    ~ProcessVideoFilter();

    void startProcessVideoFilter(const char *srcPath, const char *videoDir,
                                 const char *filterCmd);

};


#endif //FFMPEGPRACTICE_PROCESSVIDEOFILTER_H
