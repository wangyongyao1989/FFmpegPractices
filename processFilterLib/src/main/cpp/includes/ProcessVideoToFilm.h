...
#ifndef FFMPEGPRACTICE_PROCESSVIDEOTOFILM_H
#define FFMPEGPRACTICE_PROCESSVIDEOTOFILM_H
...
private:
    ...
    void ProcessVideoToFilmProcedure();
...
public:
    ProcessVideoToFilm(JNIEnv *env, jobject thiz);

    ~ProcessVideoToFilm();

    void startProcessVideoToFilm(const char *srcPath, const char *videoDir,
                                 const char *filterCmd);
};


#endif //FFMPEGPRACTICE_PROCESSVIDEOTOFILM_H
