...
public class ProcessImageFragment extends BaseFragment {
    ...
    public void initListener() {
        ...
        mBtn6.setOnClickListener(view -> {
            ...
            Random rand = new Random();
            int randomInt = rand.nextInt(100) + 1;
            String outputPath = videoDir + "out" + randomInt + ".png";
            CommonFileUtils.createFile(outputPath);
            mProcessImage.savePNGSwsFromVideo(mVideoPath2, outputPath);
        });
        ...
        mBtn7.setOnClickListener(view -> {
            ...
            Random rand = new Random();
            int randomInt = rand.nextInt(100) + 1;
            String outputPath = videoDir + "out" + randomInt + ".bmp";
            CommonFileUtils.createFile(outputPath);
            mProcessImage.saveBMPSwsFromVideo(mVideoPath2, outputPath);
        });
